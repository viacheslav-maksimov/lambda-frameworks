...
variable "project" { default = "micronaut-native-user-score" }

# Lambda function bucket
variable "lambda_bucket" { default = "test.lambda-package" }

# Lambda function bucket path
variable "lambda_bucket_path" { default = "micronaut-native-user-score" }
...
variable "handler" { default = "edu.lambda.LambdaFunction::execute" }
